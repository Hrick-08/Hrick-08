...
const Education = () => {
  ...
  return (
    <section id="education" className="mobile-py">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 space-y-2 sm:space-y-0">
                        ...
                        <span className={`font-pixel text-xs px-2 py-1 w-fit ${
                          edu.status === 'current' 
            ...
            >
              <div className="retro-speech-bubble">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-pixel mobile-text-sm text-gray-800 dark:text-gray-200 mb-2">
                      Current Studies
                    </h4>
                    <ul className="font-retro mobile-text-sm text-gray-600 dark:text-gray-400 space-y-1">
