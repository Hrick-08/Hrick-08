...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
      ...
      <div className="max-w-7xl mx-auto mobile-px text-center relative z-10 w-full overflow-hidden">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="retro-window max-w-4xl mx-auto overflow-hidden"
        >
          ...
          <div className="p-6 sm:p-8 md:p-12 overflow-hidden">
            <motion.div
            ...
            >
              <h1 className="font-pixel mobile-text-4xl sm:text-5xl lg:text-6xl text-gray-800 mb-4 text-shadow break-words">
                Hritabrata Das
              </h1>
              <p className="font-retro mobile-text-lg sm:text-xl md:text-2xl text-retro-muted-blue mb-4 sm:mb-6 break-words">
            ...
            <motion.div
              ...
              className="mb-6 sm:mb-8"
            >
              <p className="font-retro mobile-text-base sm:text-lg md:text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed break-words">
            ...
            <motion.div
              ...
              className="flex flex-wrap justify-center mobile-gap mb-6 sm:mb-8"
            >
              <div className="flex items-center space-x-2 retro-badge">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <span className="font-retro mobile-text-sm break-words">hritabratadas8@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2 retro-badge">
                <Phone className="w-4 h-4 flex-shrink-0" />
                <span className="font-retro mobile-text-sm break-words">+91-9382058536</span>
              </div>
              <div className="flex items-center space-x-2 retro-badge">
                <span className="font-retro mobile-text-sm break-words">📍 Punjab, India</span>
              </div>
            </motion.div>
